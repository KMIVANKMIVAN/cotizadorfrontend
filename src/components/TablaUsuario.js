...
import UsuarioBuscarPruAI from "./UsuarioBuscarPruAI";
import UsuarioBuscarPruAIActi from "./UsuarioBuscarPruAIActi";
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return (
            <div>
              <UsuarioBuscarPru
                url={url}
                bid={data?.MostrarUsuario[tableMeta.rowIndex].id}
              />
            </div>
          );
        },
